...
model_relu.add(Dense(n_hidden_start,kernel_initializer=initializer))
...
new_a_model.add(Dense(n_hidden_start,kernel_initializer=initializer, activation='relu'))
...
new_a_model = Sequential()
new_a_model.add(Flatten(input_shape=(32,32,1,)))
new_a_model.add(Dense(n_hidden_start,kernel_initializer=initializer))
